...
class Aluno(models.Model):  
    ...
    fone1 = models.IntegerField('Telefone',blank=True, null=True)
    fone2 = models.IntegerField('Celular',blank=True, null=True)
    fone3 = models.IntegerField('Whatsapp',blank=True, null=True)
    pai = models.CharField(max_length=100, blank=True, null=True)
    fone4 = models.IntegerField('Telefone',blank=True, null=True)
    mãe = models.CharField(max_length=100, blank=True, null=True)
    fone5 = models.IntegerField('Telefone',blank=True, null=True)
