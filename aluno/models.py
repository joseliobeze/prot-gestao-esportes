...
class Aluno(models.Model):  
    ...
    rg = models.CharField('RG/Certidão de nascimento', max_length=50, blank=True, null=True)
    cpf = models.CharField('CPF', max_length=14, blank=True, null=True)
    sexo = models.CharField('Sexo', max_length=4, choices=TIPO_SEXO, blank=True, null=True)
    altuna = models.DecimalField('Altura', max_digits=8, decimal_places=2, default=0, blank=True, null=True)
    ...
    endereco = models.ForeignKey(Endereços, on_delete=models.CASCADE, verbose_name='Endereço', blank=True, null=True)
